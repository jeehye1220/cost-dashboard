...
# CSV 파일 경로 (25FW용)
CSV_FILE = 'public/DX FW.csv'
FX_FILE = 'public/DX FX FW.csv'
OUTPUT_FILE = 'public/summary_discovery.json'
...
def main():
    """메인 함수"""
    print("F&F Cost Dashboard - Summary JSON Generation (DISCOVERY)")
    print("=" * 60)
    ...
    print(f"   > summary_discovery.json generated successfully!")
    print("\n" + "=" * 60)

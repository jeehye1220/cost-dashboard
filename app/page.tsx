  ...
  useEffect(() => {
    const loadAllSummaries = async () => {
      try {
        ...
        '26SS-M': { summary: 'COST RAW/26SS/summary_26s_m.json', fx: 'COST RAW/FX.csv' },
        '26SS-I': { summary: 'COST RAW/26SS/summary_26s_i.json', fx: 'COST RAW/FX.csv' },
        '26SS-X': { summary: 'COST RAW/26SS/summary_26s_x.json', fx: 'COST RAW/FX.csv' },
        '26SS-DISCOVERY-KIDS': { summary: 'COST RAW/26SS/summary_26s_x_kids.json', fx: 'COST RAW/FX.csv' },
        '26SS-ST': { summary: 'COST RAW/26SS/summary_26s_st.json', fx: 'COST RAW/FX.csv' },
        '26SS-V': { summary: 'COST RAW/26SS/summary_26s_v.json', fx: 'COST RAW/FX.csv' },
        ...
        '26SS-M-NON': { summary: 'COST RAW/26SS/summary_26s_m_non.json', fx: 'COST RAW/FX_NON.csv' },
        '26SS-I-NON': { summary: 'COST RAW/26SS/summary_26s_i_non.json', fx: 'COST RAW/FX_NON.csv' },
        '26SS-X-NON': { summary: 'COST RAW/26SS/summary_26s_x_non.json', fx: 'COST RAW/FX_NON.csv' },

...
# -*- coding: utf-8 -*-
"""
25FW 기간 ST, V 브랜드 AI 분석 및 Insights CSV 생성 스크립트
"""
...
# 브랜드 정보 (ST, V만)
brands = [
    {"brandId": "ST", "brandCode": "ST"},
    {"brandId": "V", "brandCode": "V"},
]
...
def generate_insights():
    ...
    print("=" * 60)
    print("25FW 기간 ST, V 브랜드 AI 분석 시작")
    print("=" * 60)
    print(f"기간: {period}")
    ...
    try:
        ...
        print("생성된 파일 위치:")
        for b in brands:
            print(f"  - public/COST RAW/25FW/{b['brandCode']}_insight_25fw.csv")

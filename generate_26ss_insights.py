...
# -*- coding: utf-8 -*-
"""
26SS 기간 AI 분석 및 Insights CSV 생성 스크립트
"""
...
# 브랜드 정보
brands = [
    {"brandId": "26SS-M", "brandCode": "M"},
    {"brandId": "26SS-I", "brandCode": "I"},
    {"brandId": "26SS-X", "brandCode": "X"},
    {"brandId": "26SS-ST", "brandCode": "ST"},
    {"brandId": "26SS-V", "brandCode": "V"},
]
...
def generate_insights():
    ...
    try:
        ...
        print("생성된 파일 위치:")
        for b in brands:
            print(f"  - public/COST RAW/26SS/{b['brandCode']}_insight_26ss.csv")

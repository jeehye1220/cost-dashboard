...
stor_filtered as (
    select 
        ...
        qty,
        case 
            when stor_dt between date '2024-12-01' and date '2025-05-31' then '전년'
            when stor_dt between date '2025-12-01' and date '2025-11-28' then '당년'
        end as period_label
    from prcs.dw_stor
    where (stor_dt between date '2024-12-01' and date '2025-05-31')
       or (stor_dt between date '2025-12-01' and date '2025-11-28')
),
-- B) 기간 내 PO만 (중복 방지용)
stor_po as (

...
# CSV 파일 경로 (25FW용)
CSV_FILE = 'public/MLB FW.csv'
FX_FILE = 'public/FX FW.csv'
OUTPUT_FILE = 'public/summary_25fw.json'
...
def main():
    """메인 함수"""
    print("F&F Cost Dashboard - Summary JSON Generation (25FW)")
    print("=" * 60)
    ...
    print(f"   > summary_25fw.json generated successfully!")
    print("\n" + "=" * 60)
